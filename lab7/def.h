...
enum node_kind { EXT_DEF_LIST,EXT_VAR_DEF,FUNC_DEF,FUNC_DEC,EXT_DEC_LIST,STRUCT_TAG,
                 PARAM_LIST,PARAM_DEC,VAR_DEF,DEC_LIST,DEF_LIST,COMP_STM,
                 STM_LIST,EXP_STMT,IF_THEN,IF_THEN_ELSE,FUNC_CALL,ARGS,FUNCTION,
                 PARAM,ARG,CALL,LABEL,GOTO,JLT,JLE,JGT,JGE,EQ,NEQ,FOR_NODE,
                 SELFADD_L,SELFADD_R,SELFMINUS_L,SELFMINUS_R,ARRAY_DEF,ARRAY_DEC,ARRAY_LIST,ARRAY_CALL,ARRAY};
